 ...
 */
package com.brightcns.liangla.zxing.camera;
...
public final class CameraConfigurationManager {
    ...
    private Point findBestPreviewSizeValue(Camera.Parameters parameters, Point screenResolution) {
        ...
        if (rawSupportedSizes == null) {
            Log.w(TAG, "Device returned no supported preview sizes; using splashicon");
        ...
        Log.i(TAG, "No suitable preview sizes, using splashicon: " + defaultSize);
